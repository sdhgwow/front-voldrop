...
export function PasswordLabel(props: PasswordLabelProps) {
    ...
    return (
        <div className='auth-label'>
            ...
            <div className='auth-label__pass'>
                <input className='auth-label__input' type={dropped ? 'text' : 'password'} placeholder='Пароль' value={props.value} onChange={(x) => props.setValue(x.currentTarget.value)} />
                <button type='button' className='auth-label__btn' onClick={() => setDropped((prev) => !prev)}>
                    {dropped ?
                        (
